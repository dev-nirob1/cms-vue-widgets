...
<template>
  ...
  <footer class="footer bg-dark text-white">
    <div class="container medium-2 large-5 gap-1 py-1 medium-py-4">
      <!-- Footer logo and contact info -->
      <div class="contact-info large-span-2">
        <RouterLink to="/" class="logo">
          <BaseImage image="https://www.webpoka.com/front/images/logo.png" alt="Real Estate Logo" />
        </RouterLink>
